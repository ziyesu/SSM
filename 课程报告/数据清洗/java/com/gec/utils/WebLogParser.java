...
public class WebLogParser {
    ...
    public static WebLogBean parser(String line) {
        ...
        if (arr.length > 11) {
            ...
            webLogBean.setRequest(arr[6].substring(arr[6].lastIndexOf("/"),arr[6].length()));
    ...
    public static void filtStaticResource(WebLogBean bean, String pages) {
        if (!pages.matches(bean.getRequest())) {
            bean.setValid(false);
        }
    }
    //格式化时间方法
